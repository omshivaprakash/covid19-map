  ...
  return (
    [
      ...
      <div className="info small text-muted" style={hidden ? {display: "none"} : {display:"block"}}>
        ...
        <span className="text-danger hideInJh hideInMomentum">Dark Red: confirmed projected at test rate (if available; w.r.t. world wide avg.)</span><br className="hideInJh hideInMomentum" />
